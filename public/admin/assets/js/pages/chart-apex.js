...
setTimeout(function () {
  ...
  (function () {
    var options = {
      ...
      colors: ['#1abc9c', '#1DE9B6', '#F4C22B', '#3EBFEA'],
      responsive: [
        {
          breakpoint: 480,
          options: {
  ...
  (function () {
    var options = {
      ...
      colors: ['#1abc9c', '#3EBFEA', '#1DE9B6', '#F4C22B', '#F44236'],
      stroke: {
        width: 1,
        colors: ['#fff']
      },
  ...
  (function () {
    ...
    var chart = new ApexCharts(document.querySelector('#mixed-chart-1'), options);
    chart.render();
  })();
  (function () {
    var options = {
    ...
    var chart = new ApexCharts(document.querySelector('#mixed-chart-2'), options);
    chart.render();
  })();
  (function () {
    var options = {
    ...
    var chart = new ApexCharts(document.querySelector('#candlestick-chart-1'), options);
    chart.render();
  })();
  (function () {
    ...
    var options = {
      ...
      colors: ['#1abc9c', '#1DE9B6', '#F4C22B', '#F44236'],
      fill: {
        opacity: 0.8
      },
      xaxis: {
    ...
    var chart = new ApexCharts(document.querySelector('#bubble-chart-1'), options);
    chart.render();
  })();
  (function () {
    ...
    var chart = new ApexCharts(document.querySelector('#bubble-chart-2'), options);
    chart.render();
  })();
  (function () {
    var options = {
      ...
      colors: ['#1abc9c', '#1DE9B6', '#F44236', '#F4C22B', '#3EBFEA'],
      series: [
        {
          name: 'SAMPLE A',
          data: [
    ...
    var chart = new ApexCharts(document.querySelector('#scatter-chart-1'), options);
    chart.render();
  })();
  (function () {
    var options = {
    ...
    var chart = new ApexCharts(document.querySelector('#scatter-chart-2'), options);
    chart.render();
  ...
  (function () {
    ...
    var chart = new ApexCharts(document.querySelector('#heatmap-chart-1'), options);
    chart.render();
  })();
  (function () {
    ...
    var chart = new ApexCharts(document.querySelector('#heatmap-chart-2'), options);
    chart.render();
  })();
  (function () {
    var options = {
      ...
      colors: ['#1abc9c', '#1DE9B6', '#3EBFEA', '#F4C22B', '#F44236'],
      legend: {
        show: true,
        position: 'bottom'
      },
  ...
  (function () {
    ...
    var chart = new ApexCharts(document.querySelector('#radar-chart-1'), options);
    chart.render();
  })();
  (function () {
    var options = {
    ...
    var chart = new ApexCharts(document.querySelector('#radar-chart-2'), options);
    chart.render();
